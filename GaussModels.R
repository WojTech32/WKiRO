...
data <- generate_gaussian_data(n = 100, center1 = c(-1, -1), center2 = c(1, 1))

# 2. Grou jako kategorie
...
# SVM metryki
cat("\n=== SVM ===\n")
cm_svm <- confusionMatrix(svm_pred, true_labels)
print(cm_svm)
...
#Bayes metryki
cat("\n=== Naive Bayes ===\n")
cm_nb <- confusionMatrix(nb_pred, true_labels)
print(cm_nb)
...
#saveRDS(svm_model, "svm_model_Gauss.rds")
#saveRDS(nb_model, "nb_model_Gauss.rds")
